...
public class Money {
    ...
    public static Money MAX_CAPACITY = new Money(BigDecimal.valueOf(1000.0));
    ...
    public boolean isEqule(Money money) {
        return this.pocket.compareTo(money.get()) == 0;
    }
    ...
    public boolean checkCapacity(Money money) {
        Money temp = new Money(this.pocket);
        temp = temp.add(money);
        return (temp.isLessThan(MAX_CAPACITY) || temp.isEqule(MAX_CAPACITY));
    }
}
